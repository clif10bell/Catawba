...
## Summary Tables for Chlorophyll-a, DO, and pH

The following tables present summary statistics for chla, DO, and pH by reservoir
and station. The stats are calculated from data from the growing season,
...
## Scatterplots of DO, pH, and Secchi depth vs Chlorophyll-a
...
```{r, echo=FALSE, fig.cap="Figure X - Secchi depth vs chla at Fishing Creek Reservoir stations.", results = "asis", message = FALSE, warning = FALSE}
scatter1("Secchi", "pH", c("CW-016F", "LCR-04", "CW-057"), regression = TRUE)   # Fishing Creek Res. Stations
```

```{r, echo=FALSE, fig.cap="Figure X - Secchi depth vs chla at Cedar Creek Reservoir stations.", results = "asis", message = FALSE, warning = FALSE}
scatter1("Secchi", "pH", c("CW-174", "CW-033"),  regression = TRUE)              # Cedar Creek Res. Stations
```

```{r, echo=FALSE, fig.cap="Figure X - Secchi depth vs chla at Lake Wateree Reservoir stations.", results = "asis", message = FALSE, warning = FALSE}
scatter1("Secchi", "pH", c("CW-231", "CW-208", "CW-207B", "CL-089"),  regression = TRUE)   # Lake Wateree Stations
```
...
# Microcystin boxplots
The charts demonstrate the great majority of the routine microcystin monitoring
data are less than the most stringent drinking water threshold (0.3 ug/L) in all
reservoirs. Obviously they are also much lower than the recreational threshold
of 8 ug/L.

```{r, echo=FALSE, fig.cap="Figure X - Spatial pattern in microcystin in Fishing Creek Reservoir."}
boxplots1("Microcystin", "FISHING CREEK RESERVOIR", min_scale = 0, max_scale = 0.25)
```

```{r, echo=FALSE, fig.cap="Figure X - Spatial pattern in microcystin in Cedar Creek Reservoir."}
boxplots1("Microcystin", "CEDAR CREEK RESERVOIR", min_scale = 0, max_scale = 0.4)
```

```{r, echo=FALSE, fig.cap="Figure X - Spatial pattern in microcystin in Lake Wateree."}
